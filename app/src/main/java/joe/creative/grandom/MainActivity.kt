...
class MainActivity : AppCompatActivity() {
    val mainFragment: Home = Home();
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        setSupportActionBar(toolbar)

        println("log- Call here")
    ...
    fun openSecondFragment(generatedNumber: String) {
        var bundle: Bundle = Bundle();
        val secondFragment:second = second();
        // set bundle strings for fragement arguments
        bundle.putString("GENERATED_NUMBER", generatedNumber);
